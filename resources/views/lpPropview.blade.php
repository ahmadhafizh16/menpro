                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8" style="padding-bottom: 60px;">
                        <div class="single-page-post">
                            @if(!empty($pen->canvas))
                            <img class="img-fluid" src="{{asset("$pen->canvas")}}" alt="" style="width:60%;max-height:487px;margin-left:25%;border: 1px solid #c9c9c9;">
                            @else
                            <img class="img-fluid" src="{{asset("$pen->banner")}}" alt="" style="width:60%;max-height:487px;margin-left:25%;border: 1px solid #c9c9c9;">
                            @endif
